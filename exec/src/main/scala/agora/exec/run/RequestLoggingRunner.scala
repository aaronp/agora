...
import agora.domain.AlphaCounter
import agora.exec.dao.ExecDao
...
/**
  ...
  *
  */
class RequestLoggingRunner(underlying: ProcessRunner, dao: ExecDao.FileExecDao, nextId: BufferedIterator[String] = AlphaCounter.from(0))(implicit mat: Materializer)
